...
void Vtop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/shakti/Downloads/mult_and_accum_pip/verilog/mac.v", 44, "",
...
VL_INLINE_OPT void Vtop::_sequent__TOP__4(Vtop__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlTOPp->RST_N) {
        if (vlTOPp->mac__DOT__count_EN) {
            vlTOPp->mac__DOT__count = vlTOPp->mac__DOT__count_D_IN;
        }
    } else {
        vlTOPp->mac__DOT__count = 0U;
    }
    if (vlTOPp->RST_N) {
    ...
    if (vlTOPp->RST_N) {
        if (vlTOPp->mac__DOT__mult_float_result_EN) {
            vlTOPp->mac__DOT__mult_float_result = vlTOPp->mac__DOT__mult_float_result_D_IN;
        }
    } else {
        vlTOPp->mac__DOT__mult_float_result = 0U;
    }
    if (vlTOPp->RST_N) {
        if (vlTOPp->mac__DOT__mult_int_result_EN) {
            vlTOPp->mac__DOT__mult_int_result = vlTOPp->mac__DOT__mult_int_result_D_IN;
        }
    } else {
        vlTOPp->mac__DOT__mult_int_result = 0U;
    }
    if (vlTOPp->RST_N) {
